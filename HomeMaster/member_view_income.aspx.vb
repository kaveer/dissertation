...
Public Class member_view_income
    ...
    '################################################# THEME SETUP ###################################################################
    Private Sub member_view_income_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_remove_expense_Click(sender As Object, e As EventArgs) Handles btn_remove_expense.Click
        ...
        Else
            ...
            Response.Redirect("./member_view_income.aspx")
        End If
    End Sub
