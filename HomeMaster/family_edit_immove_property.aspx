<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master"  Culture = "en-GB" EnableEventValidation = "false"  CodeBehind="family_edit_immove_property.aspx.vb" Inherits="HomeMaster.family_edit_immove_property" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="maindivChildHome"> 
         <table>
            <tr>
                <td>
                    <asp:Label ID="lbl_title" runat="server" CssClass="title_all" Text="Edit property"></asp:Label>
                </td>
            </tr>
        </table>
