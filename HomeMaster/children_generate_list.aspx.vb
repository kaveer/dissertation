...
Public Class children_generate_list
    ...
    '###################################### THEME SET UP ####################################################################
    Private Sub children_generate_list_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
            ...
            For Each row As GridViewRow In GridView_generate.Rows
                If row.RowType = DataControlRowType.DataRow Then
                    ...
                    If chkRow.Checked = True Then
                        ...
                        sqlCmd2.Parameters.AddWithValue("@catName", CStr(row.Cells(2).Text))
                        con2.Open()
