<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master" EnableEventValidation = "false" CodeBehind="family_view_immov_property.aspx.vb" Inherits="HomeMaster.family_view_immov_property" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="maindivChildHome">
         <table>
            <tr>
                <td>
                    <asp:Label ID="lbl_title" CssClass="title_all" runat="server" Text="View all  property"></asp:Label>
                </td>
            </tr>
        </table>
         <table>
