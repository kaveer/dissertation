<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/member.Master" Culture = "en-GB"  EnableEventValidation = "false" CodeBehind="member_edit_moveable_asset.aspx.vb" Inherits="HomeMaster.member_edit_moveable_asset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="maindivChildHome">
         <table>
            <tr>
                <td>
                    <asp:Label ID="lbl_title" CssClass="title_all" runat="server" Text="Edit asset"></asp:Label>
                </td>
            </tr>
        </table>
