...
Public Class family_home_form
    ...
    '################################################ THEME SETUP ###########################################################################
    Private Sub family_home_form_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub check_online_validation()
        ...
        If reader.Read() Then
            Response.Redirect("./family_online_activation.aspx")
            con.Close()
        End If
    End Sub
    ...
    Private Sub btn_add_notes_Click(sender As Object, e As EventArgs) Handles btn_add_notes.Click
        Response.Redirect("./family_add_note.aspx")
    End Sub
    ...
    Private Sub btn_open_family_album_Click(sender As Object, e As EventArgs) Handles btn_open_family_album.Click
        Response.Redirect("./family_family_album_folder.aspx")
    End Sub
