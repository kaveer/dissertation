...
Public Class family_view_edit_loan_form
    ...
    Private Sub editloan_btn_Click(sender As Object, e As EventArgs) Handles editloan_btn.Click
        Response.Redirect(".\family_edit_loan_form.aspx")
    End Sub
    '########################################## END OF NAVIGATION ########################################################################

    '########################################### THEME SETUP ###################################################################
    Private Sub family_view_edit_loan_form_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
