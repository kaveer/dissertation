...
Public Class member_view_insurance
    ...
    '###################################### THEME SETUP ##################################################################
    Private Sub member_view_insurance_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_edit_insurance_Click(sender As Object, e As EventArgs) Handles btn_edit_insurance.Click
        Response.Redirect("./member_edit_insurance.aspx")
    End Sub
