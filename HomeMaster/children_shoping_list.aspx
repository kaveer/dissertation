<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/children.Master" EnableEventValidation = "false" CodeBehind="children_shoping_list.aspx.vb" Inherits="HomeMaster.children_shoping_list" %>
                        ...
                        <asp:Panel ID="panel_add_new_product" Visible="false" runat="server">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CompareValidator ID="validation_for_unitP" runat="server" Operator="DataTypeCheck" Type="Currency" ControlToValidate="txtbx_unit_price" ForeColor="Red" ErrorMessage="Enter correct amount" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
