<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master" EnableEventValidation = "false" CodeBehind="family_view_move_asset.aspx.vb" Inherits="HomeMaster.family_view_move_asset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div  class="maindivChildHome">
        ...
        <asp:Panel ID="Panel_open_gallery" CssClas="popViewAsset_pic" ScrollBars="Vertical" Height="700px" Visible="false"  runat="server">
            <table>
                <tr>
                    <td>
