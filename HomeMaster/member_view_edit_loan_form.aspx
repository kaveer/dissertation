<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/member.Master"  EnableEventValidation = "false" CodeBehind="member_view_edit_loan_form.aspx.vb" Inherits="HomeMaster.member_view_edit_loan_form" %>
