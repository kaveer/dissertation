<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master" Culture = "en-GB" CodeBehind="family_generate_list.aspx.vb" Inherits="HomeMaster.family_generate_list" %>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="GridView_merge_list" CssClass="grid"   runat="server"></asp:GridView>
                                </ContentTemplate>
                                <Triggers>
