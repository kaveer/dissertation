...
Public Class children_view_expense
    ...
    '################################################# THEME SETUP ###################################################################
    Private Sub children_view_expense_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_remove_expense_Click(sender As Object, e As EventArgs) Handles btn_remove_expense.Click
        ...
        Else
            ...
            Response.Redirect("./children_view_expense.aspx")
        End If
    End Sub
