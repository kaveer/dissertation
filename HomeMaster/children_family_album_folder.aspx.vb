...
Public Class children_family_album_folder
    ...
    '################################################# THEME SETUP ###################################################################
    Private Sub children_family_album_folder_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_open_folder_Click(sender As Object, e As EventArgs) Handles btn_open_folder.Click
        ...
        Else
            ...
            Response.Redirect("./children_family_album_photo.aspx")
        End If
    End Sub
