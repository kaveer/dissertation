...
Public Class family_add_repay_insur
    ...
    '############################################# THEME SETUP ############################################################
    Private Sub family_add_repay_insur_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_view_repayment_Click(sender As Object, e As EventArgs) Handles btn_view_repayment.Click
        Response.Redirect("./family_view_repayment.aspx")
    End Sub
End Class