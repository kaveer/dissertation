...
Public Class family_shop_list_form
    ...
    '#################################### THEME SETUP ################################################################
    Private Sub family_shop_list_form_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_view_by_cat_Click(sender As Object, e As EventArgs) Handles btn_view_by_cat.Click
        Response.Redirect("./family_view_by_category.aspx")
    End Sub
