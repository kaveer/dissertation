...
Public Class member_edit_loan_form
    ...
    '########################################## THEME SETUP ##########################################################################
    Private Sub member_edit_loan_form_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
...
'Private Sub ddl_loanname_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_loanname.SelectedIndexChanged
'    Dim con2 As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
...
'    Dim sqlCmd2 As New SqlCommand(sql2, con2)
'    sqlCmd2.Parameters.AddWithValue("@nameT", ddl_loanname.SelectedItem.Text)
'    con2.Open()
'    Dim reader2 As SqlDataReader = sqlCmd2.ExecuteReader()
'    If reader2.Read() = True Then
'        Session("Vtransac") = reader2("transaction_id")
'    End If
'    con2.Close()

'    select_gridview_repayment()
'    select_gridview_mail()
'    select_gridview_location()
'    select_gridview_contact()
'    select_name_descri_type()
'    select_all_loaninfo()
'    select_loan_type()

'End Sub
'Private Sub select_gridview_repayment()
'    Dim con As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql = "select capital_paid , interest_paid , payment_date , repay_interest_rate , remarks from loan_pay_tbl as repay inner join loan_tbl as loan on loan.transaction_id = repay.transaction_id where loan_name = @loannamT and loan.transaction_id = @tansT "
'    Dim sqlCmd As New SqlCommand(sql, con)
'    sqlCmd.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con.Open()
'    Dim sqladap = New SqlDataAdapter(sqlCmd)
'    Dim dt = New DataTable
'    sqladap.Fill(dt)
...
'    con.Close()
'End Sub
'Private Sub select_gridview_mail()
'    Dim con As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql = "select mail , lender_mail_id as ref  from lender_mail_tbl as m inner join lender_tbl as l on l.lender_id = m.lender_id inner join loan_tbl as o on l.lender_id = o.lender_id where loan_name =  @loannamT and transaction_id = @tansT "
'    Dim sqlCmd As New SqlCommand(sql, con)
'    sqlCmd.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con.Open()
...
'    Dim dt = New DataTable
'    sqladap.Fill(dt)
'    GridView_lendermail.DataSource = dt
'    GridView_lendermail.DataBind()
'    con.Close()
'End Sub
'Private Sub select_gridview_location()
'    Dim con As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql = "select  street , town ,country , postal_code  from location_tbl as o inner join lender_tbl as l on l.lender_id=o.lender_id inner join loan_tbl as a on a.lender_id = l.lender_id where loan_name =  @loannamT and transaction_id = @tansT "
'    Dim sqlCmd As New SqlCommand(sql, con)
'    sqlCmd.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con.Open()
...
'    Dim dt = New DataTable
'    sqladap.Fill(dt)
'    GridView_lenderlocation.DataSource = dt
'    GridView_lenderlocation.DataBind()
'    con.Close()

'End Sub
'Private Sub select_gridview_contact()
'    Dim con As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql = "select phone , fax ,website from contact_tbl as c inner join lender_tbl as l on l.lender_id = c.lender_id inner join loan_tbl as o on l.lender_id = o.lender_id where loan_name =  @loannamT and transaction_id = @tansT "
'    Dim sqlCmd As New SqlCommand(sql, con)
'    sqlCmd.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con.Open()
...
'    Dim dt = New DataTable
'    sqladap.Fill(dt)
'    gridview_lendercontact.DataSource = dt
'    gridview_lendercontact.DataBind()
'    con.Close()
'End Sub
'Private Sub select_name_descri_type()
'    Dim con2 As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql2 = "select * from lender_tbl as l inner join lender_type_tbl as t on l.type_id = t.type_id inner join loan_tbl as o on o.lender_id = l.lender_id where loan_name = @loannamT and transaction_id = @tansT  "
'    Dim sqlCmd2 As New SqlCommand(sql2, con2)
'    sqlCmd2.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd2.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con2.Open()
'    Dim reader2 As SqlDataReader = sqlCmd2.ExecuteReader()
'    If reader2.Read() = True Then
'        lbl_current_name.Text = reader2("name")
'        lbl_current_description.Text = reader2("lender_description")
'        lbl_current_lendertype.Text = reader2("lender_type")
'    End If
'    con2.Close()
'End Sub
'Private Sub select_all_loaninfo()
'    Dim con2 As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql2 = "select * from loan_tbl where loan_name = @loannamT and transaction_id = @tansT  "
'    Dim sqlCmd2 As New SqlCommand(sql2, con2)
'    sqlCmd2.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd2.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con2.Open()
'    Dim reader2 As SqlDataReader = sqlCmd2.ExecuteReader()
'    If reader2.Read() = True Then
'        lbl_current_loanname.Text = reader2("loan_name")
'        lbl_current_loandetail.Text = reader2("loan_detail")
'        lbl_current_amount.Text = reader2("amount_given")
'        lbl_current_interest_rate.Text = reader2("interest_rate")
'        lbl_current_guarantor.Text = reader2("guarantor")
'        lbl_current_mortgage.Text = reader2("mortgage")
'        lbl_current_date.Text = reader2("date_taken")
'        lbl_current_loanterm.Text = reader2("loan_term")
'    End If
'    con2.Close()
'End Sub
'Private Sub select_loan_type()
'    Dim con2 As New SqlConnection("Data Source=kaveer-pc\SQL12HOMEMASTER;Initial Catalog=HomeMaster;Integrated Security=True")
'    Dim sql2 = "select * from loan_type_tbl as t inner join loan_tbl as l on t.loan_type_id = l.loan_type_id  where loan_name = @loannamT and transaction_id = @tansT  "
'    Dim sqlCmd2 As New SqlCommand(sql2, con2)
'    sqlCmd2.Parameters.AddWithValue("@loannamT", ddl_loanname.SelectedItem.Text)
'    sqlCmd2.Parameters.AddWithValue("@tansT", CInt(Session("Vtransac")))
'    con2.Open()
'    Dim reader2 As SqlDataReader = sqlCmd2.ExecuteReader()
'    If reader2.Read() = True Then
'        lbl_current_loantype.Text = reader2("type")
'    End If
'    con2.Close()
'End Sub
...
'    Next
'    Panel1.Visible = True
'    pnl_lender_mail_popup.Visible = False
'    pnl_popup_repayment.Visible = True
'    lbl_current_capitalPaid.Text = gridview_repayment.SelectedRow.Cells(0).Text
'    lbl_current_interestPaid.Text = gridview_repayment.SelectedRow.Cells(1).Text
'    lbl_current_payDate.Text = gridview_repayment.SelectedRow.Cells(2).Text
'    lbl_curent_interest_rate.Text = gridview_repayment.SelectedRow.Cells(3).Text
'    lbl_current_remark.Text = gridview_repayment.SelectedRow.Cells(4).Text

'End Sub
'Private Sub GridView_lendermail_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView_lendermail.RowDataBound
'    If e.Row.RowType = DataControlRowType.DataRow Then
'        e.Row.Attributes("onclick") = Page.ClientScript.GetPostBackClientHyperlink(GridView_lendermail, "Select$" & e.Row.RowIndex)
'        e.Row.ToolTip = "Click to select this row."
'    End If
'End Sub
'Private Sub GridView_lendermail_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView_lendermail.SelectedIndexChanged
'    For Each row As GridViewRow In GridView_lendermail.Rows
'        If row.RowIndex = GridView_lendermail.SelectedIndex Then
'            row.BackColor = ColorTranslator.FromHtml("#A1DCF2")
'            row.ToolTip = String.Empty
'        Else
'            row.BackColor = ColorTranslator.FromHtml("#FFFFFF")
...
'    Next
'    Panel1.Visible = True
'    pnl_lender_mail_popup.Visible = True
'    pnl_popup_repayment.Visible = False
'    lbl_current_mail.Text = GridView_lendermail.SelectedRow.Cells(0).Text
'    lbl_current_mailref.Text = GridView_lendermail.SelectedRow.Cells(1).Text
'End Sub
'Private Sub GridView_lenderlocation_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView_lenderlocation.RowDataBound
'    If e.Row.RowType = DataControlRowType.DataRow Then
'        e.Row.Attributes("onclick") = Page.ClientScript.GetPostBackClientHyperlink(GridView_lenderlocation, "Select$" & e.Row.RowIndex)
'        e.Row.ToolTip = "Click to select this row."
'    End If
'End Sub
'Private Sub GridView_lenderlocation_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView_lenderlocation.SelectedIndexChanged
'    For Each row As GridViewRow In GridView_lenderlocation.Rows
'        If row.RowIndex = GridView_lenderlocation.SelectedIndex Then
'            row.BackColor = ColorTranslator.FromHtml("#A1DCF2")
'            row.ToolTip = String.Empty
'        Else
'            row.BackColor = ColorTranslator.FromHtml("#FFFFFF")
...
'        End If
'    Next
'    lbl_current_street.Text = GridView_lenderlocation.SelectedRow.Cells(0).Text
'    lbl_current_town.Text = GridView_lenderlocation.SelectedRow.Cells(1).Text
'    lbl_current_country.Text = GridView_lenderlocation.SelectedRow.Cells(2).Text
'    lbl_current_postal.Text = GridView_lenderlocation.SelectedRow.Cells(3).Text

'End Sub
'Private Sub gridview_lendercontact_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gridview_lendercontact.RowDataBound
'    If e.Row.RowType = DataControlRowType.DataRow Then
'        e.Row.Attributes("onclick") = Page.ClientScript.GetPostBackClientHyperlink(gridview_lendercontact, "Select$" & e.Row.RowIndex)
'        e.Row.ToolTip = "Click to select this row."
'    End If
'End Sub
'Private Sub gridview_lendercontact_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gridview_lendercontact.SelectedIndexChanged
'    For Each row As GridViewRow In gridview_lendercontact.Rows
'        If row.RowIndex = gridview_lendercontact.SelectedIndex Then
'            row.BackColor = ColorTranslator.FromHtml("#A1DCF2")
'            row.ToolTip = String.Empty
'        Else
'            row.BackColor = ColorTranslator.FromHtml("#FFFFFF")
...
'    lbl_current_phone.Text = gridview_lendercontact.SelectedRow.Cells(0).Text
'    lbl_current_fax.Text = gridview_lendercontact.SelectedRow.Cells(1).Text
'    lbl_current_website.Text = gridview_lendercontact.SelectedRow.Cells(2).Text
'End Sub

'Private Sub btn_cancel_popup_Click(sender As Object, e As EventArgs) Handles btn_cancel_popup.Click
