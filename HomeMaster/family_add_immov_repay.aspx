<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master" Culture = "en-GB" EnableEventValidation = "false" CodeBehind="family_add_immov_repay.aspx.vb" Inherits="HomeMaster.family_add_immov_repay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="maindivChildHome">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lbl_title" CssClass="title_all" runat="server" Text="View all moveable asset"></asp:Label>
                </td>
            </tr>
        </table>
                    ...
                    <tr>
                        ...
                        <%--<td>
                            <asp:Repeater ID="Repeater1" runat="server">
                                ...
                                <FooterTemplate>
                                    <br />
                                     <asp:Button ID="Button1" CommandName="open_gallery" runat="server" Text="Open gallery" />
                                </FooterTemplate>
                            </asp:Repeater>
                        </td>--%>
                    </tr>
