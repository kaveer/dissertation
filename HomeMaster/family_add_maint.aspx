<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/family.Master"  Culture = "en-GB" EnableEventValidation = "false" CodeBehind="family_add_maint.aspx.vb" Inherits="HomeMaster.family_add_maint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="maindivChildHome">
         <table>
            <tr>
                <td>
                    <asp:Label ID="lbl_title"  CssClass="title_all" runat="server" Text="Add maintenance"></asp:Label>
                </td>
            </tr>
        </table>
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btn_add_immv_prop" CssClass="btn" runat="server" Text="Add propery" />
                    <asp:Button ID="btn_add_mov_asset" CssClass="btn" runat="server" Text="Add movable asset" />
                </td>
            </tr>
            </table>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        <td>
                        <asp:GridView ID="GridView_select_movable" CssClass="grid" AllowPaging="true" PageSize="5" runat="server"></asp:GridView>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="GridView_select_movable" EventName="SelectedIndexChanged" />
            </Triggers>
        </asp:UpdatePanel>
        <table>
            <tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lbl_maint_worker" runat="server" Text="contractor/worker"></asp:Label>
                </td>
                <td>
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="btn_save_maintenance" CssClass="btn" runat="server" Text="Save" />
                </td>
                <td>
