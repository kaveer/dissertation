...
Public Class children_add_note
    ...
    '################################################# THEME SETUP ###################################################################
    Private Sub children_add_note_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub btn_view_note_Click(sender As Object, e As EventArgs) Handles btn_view_note.Click
        Response.Redirect("./children_view_note.aspx")
    End Sub
End Class